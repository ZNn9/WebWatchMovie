        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
            http
                    .authorizeHttpRequests(auth -> auth
                            .requestMatchers("/css/**", "/js/**", "/img/**", "/", "/oauth/**", "/register", "/error", "/api/**").permitAll()
                            .requestMatchers("/user/anime-details").permitAll()
                            .requestMatchers("/user/anime-watching").permitAll()
                            .requestMatchers("/user/blog").permitAll()
                            .requestMatchers("/user/blog-details").permitAll()
